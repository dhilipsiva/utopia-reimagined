...
- **The reach strategy: spine-order serialization from a home of its own**, ruled 2026-08-02,
  ...
  their whole-chapter passes complete** — the pass is the gate, so reach sequences behind
  Phase 3's discipline — from a dedicated domain the author registers, with platforms
