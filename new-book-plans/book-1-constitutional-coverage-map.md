...
| Democracy and amendment | **Partial:** vote, recall, proposal, approval, and declared-target label verdicts exist. | Residence-first adult franchise and candidacy; proportional People's Assembly; limited Regions Council; confidence government; public reasons; majority law and bounded initiatives inside constitutional limits; constructive recall; authenticated constitutional amendment and review; and an enterprise-treasury ban on candidate, party, and purchased independent electoral advocacy. | Partial formalisation; state form, political membership, and democratic corridor author-ratified; architecture unimplemented. | The current machinery does not authenticate an electorate, approval writer, tally, certificate, recount, challenge, or correction; bind a proposal to an exact source change; review semantic effects; or apply an authenticated effective-version transition. The bounded audit executes label/effect counterexamples only. Legacy `decide`, `broken`, and `approves` are not a vote, recall, referendum, amendment, or lawful result. No enterprise-finance predicate, treasury-source boundary, civic/union card, or anti-relabeling rule exists. |
...
2. ~~Rule the taxonomy, time model, state form, political membership,
   substantive equality, and the economic/private-sphere settlement.~~ **Done
   2026-08-07.** Use those ratified decisions and the implemented, power-scoped
   T3 path to complete this map’s fields and scenario tests for each proposed
   domain. The state, equality, and economic architectures and democratic
   corridor are ratified but not formalised.
3. Complete one contract card for every ratified institution, membership status,
   public power, result record, transfer route, economic limit, public-like
   private duty, and scarcity allocation before adding constitutional
...
- Any economic family must audit the opening note; Chapters 1–4 and 6–14;
  ...
  and State verdicts. The ecology half of the combined economy/commons row
  remains open.
