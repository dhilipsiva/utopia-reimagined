...
> **Status: draft for author ratification.** This classifies the constitutional
> work the ratified mandate requires. It does not add a right, power, predicate,
> delivery route, or claim of present formal coverage.

## Decision

Adopt the nine functional classes below. Every proposed Book 1 rule family gets
one **primary class**. It can depend on other classes, but it must not become a
hybrid slogan such as “a right to good government.” The class tells us what the
rule must prove, who it binds, and what belongs in Book 2.
...
This is functional symmetry, not a fixed number of rights or branches. Different
classes have different grammars because provision, coercion, democratic choice,
and evidence are not moral or mathematical opposites.
...
| Records and accountability | 7 | 1 protects standing; 4 supplies challenge and correction. |
| Economy, property, work, and commons | **Split required** | 5 governs compatible ordinary economic policy; 6 public fiscal duty; 9 commons/non-regression; recognition remains outside allocation. |
| Locality, plurality, mobility, and external relations | **Split required** | 8 handles jurisdiction/locality; 3 movement/association; 1 newcomer standing; 4 migration procedure; 6 external public authority. |
| Emergency and resilience | **Overlay, not a tenth class** | It modifies 3–7 but cannot override standing, core floors, evidence rights, or appeal. |
...
These rules apply across the classes; they are not new classes.
...
4. **Evidence is not self-certification:** a provider’s assertion cannot alone
   ...
   accessible service, receipt, dispute, and correction.
...
For each proposal, answer in order:
...
Choose the earliest adequate primary class. Mark secondary dependencies rather
than collapsing them into an omnibus “right.” If two classes appear equally
primary, split the proposal into two contract cards.

## Formalisation metadata

Every contract card also records: its class; permitted and prohibited inputs;
permitted downstream effects; evidence authority; conflict rule; temporal status;
formal status; negative-test ID; counterfactual ID; Part V status; and Book 2
handoff. This makes the taxonomy a control on dangerous edges, not a prettier
table of topics.

## Acceptance gate

The author should ratify this draft only if it preserves these conclusions:
