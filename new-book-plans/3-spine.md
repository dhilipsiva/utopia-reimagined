...
|---|---|---|---|---|
| computed from the constitution | **57** | **27** | **58** | **4** |
...
| Stratum | Predicates |
|---|---|
| **0** | `adjust`, `approves`, `attack`, `authority` *(monotone cone)*, `broken`, `capture`, `choose`, `cite`, `clean` *(monotone cone)*, `clear`, `cruel`, `deceive`, `equals`, `family`, `forgive`, `free`, `hears`, `home`, `injure`, `judge`, `married`, `mature`, `parent`, `permanent`, `public`, `put`, `rotten`, `show`, `sibling`, `suggest`, `teaches`, `work` |
...
Evidence predicates (29), the complete list of what the world may report: `adjust`, `approves`, `attack`, `broken`, `capture`, `choose`, `cite`, `clear`, `cruel`, `deceive`, `family`, `forgive`, `free`, `hears`, `home`, `injure`, `judge`, `married`, `mature`, `parent`, `permanent`, `public`, `put`, `rotten`, `show`, `sibling`, `suggest`, `teaches`, `work`.
