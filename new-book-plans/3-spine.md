...
|---|---|---|---|---|
| computed from the constitution | **55** | **27** | **57** | **4** |
...
| Stratum | Predicates |
|---|---|
| **0** | `adjust`, `approves`, `attack`, `authority` *(monotone cone)*, `broken`, `capture`, `choose`, `clean` *(monotone cone)*, `clear`, `cruel`, `deceive`, `equals`, `family`, `forgive`, `free`, `home`, `injure`, `judge`, `married`, `mature`, `parent`, `permanent`, `public`, `put`, `rotten`, `show`, `sibling`, `suggest`, `teaches`, `work` |
...
Evidence predicates (27), the complete list of what the world may report: `adjust`, `approves`, `attack`, `broken`, `capture`, `choose`, `clear`, `cruel`, `deceive`, `family`, `forgive`, `free`, `home`, `injure`, `judge`, `married`, `mature`, `parent`, `permanent`, `public`, `put`, `rotten`, `show`, `sibling`, `suggest`, `teaches`, `work`.
