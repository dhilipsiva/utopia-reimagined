...
| Stratum | Predicates |
|---|---|
| **0** | `adjust`, `approves`, `attack`, `authority` *(monotone cone)*, `broken`, `capture`, `choose`, `clear`, `cruel`, `deceive`, `equals`, `family`, `free`, `home`, `injure`, `judge`, `mature`, `parent`, `permanent`, `public`, `rotten`, `show`, `suggest`, `teaches`, `work` |
