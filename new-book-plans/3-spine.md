...
|---|---|---|---|---|
| computed from the constitution | **47** | **23** | **40** | **4** |
...
| Stratum | Predicates |
|---|---|
| **0** | `adjust`, `approves`, `authority` *(monotone cone)*, `broken`, `capture`, `choose`, `clear`, `deceive`, `derived_only`, `entitled`, `family`, `free`, `home`, `injure`, `judge`, `mature`, `parent`, `permanent`, `public`, `rotten`, `severe`, `show`, `suggest`, `teaches`, `work` |
...
Evidence predicates (22), the complete list of what the world may report: `adjust`, `approves`, `broken`, `capture`, `choose`, `clear`, `deceive`, `family`, `free`, `home`, `injure`, `judge`, `mature`, `parent`, `permanent`, `public`, `rotten`, `severe`, `show`, `suggest`, `teaches`, `work`.
